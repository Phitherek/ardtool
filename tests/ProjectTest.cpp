...
int main() {
    ...
    cout << "p1.getName(): "  << p1.getName() << endl << "p1.getPath(): " << p1.getPath() << endl << "p1.getEnv(): " << p1.getEnv() << endl << "p1.getRVM(): " << p1.getRVM() << endl << "p1.modulesEnd(): " << p1.modulesEnd() << endl << "p1.customEnd(): " << p1.customEnd() << endl << "p1.valid(): " << p1.valid() << endl;
    cout << "p2.getName(): "  << p2.getName() << endl << "p2.getPath(): " << p2.getPath() << endl << "p2.getEnv(): " << p2.getEnv() << endl << "p2.getRVM(): " << p2.getRVM() << endl << "p2.modulesEnd(): " << p2.modulesEnd() << endl << "p2.customEnd(): " << p2.customEnd() << endl << "p2.valid(): " << p2.valid() << endl;
    p1.setName("testpre");
    p1.setEnv("production");
    p1.setRVM("ruby-2.1.2@testpre");
    p1.setPath("/some/path1");
    p2.setEnv("staging");
    p2.setPath("/some/path2");
    p2.setRVM("ruby-2.1.3@test");
