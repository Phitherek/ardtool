...
int main() {
    ...
    cout << "p1.getName(): "  << p1.getName() << endl << "p1.getEnv(): " << p1.getEnv() << endl << "p1.modulesEnd(): " << p1.modulesEnd() << endl << "p1.customEnd(): " << p1.customEnd() << endl << "p1.valid(): " << p1.valid() << endl;
    cout << "p2.getName(): "  << p2.getName() << endl << "p2.getEnv(): " << p2.getEnv() << endl << "p2.modulesEnd(): " << p2.modulesEnd() << endl << "p2.customEnd(): " << p2.customEnd() << endl << "p2.valid(): " << p2.valid() << endl;
    p1.setName("testpre");
    p1.setEnv("production");
    p2.setEnv("staging");
    cout << "After name & env setup..." << endl;
    cout << "p1.getName(): "  << p1.getName() << endl << "p1.getEnv(): " << p1.getEnv() << endl << "p1.modulesEnd(): " << p1.modulesEnd() << endl << "p1.customEnd(): " << p1.customEnd() << endl << "p1.valid(): " << p1.valid() << endl;
    cout << "p2.getName(): "  << p2.getName() << endl << "p2.getEnv(): " << p2.getEnv() << endl << "p2.modulesEnd(): " << p2.modulesEnd() << endl << "p2.customEnd(): " << p2.customEnd() << endl << "p2.valid(): " << p2.valid() << endl;
    p1.addModule("bundle");
    p1.addModule("db");
